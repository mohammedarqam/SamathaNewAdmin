...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(navCtrl, db, loadingCtrl, modalCtrl, menuCtrl) {
        ...
        this.barChartLabels1 = ['Severely', 'Moderately', 'Mildly', 'Healthy'];
        this.barChartLabels2 = ['SC', 'ST', 'BC', 'OC', 'Minority'];
    ...
    DashboardPage.prototype.applyFilters = function () {
        ...
        this.filteredStudents.forEach(function (temp) {
            ...
            var data1 = [_this.totSev, _this.totMod, _this.totMild, _this.totHeal];
            var clone1 = JSON.parse(JSON.stringify(_this.barChartData1));
            clone1[0].data = data1;
            _this.barChartData1 = clone1;
            var data2 = [_this.totSC, _this.totST, _this.totBC, _this.totOC, _this.totMin];
            var clone2 = JSON.parse(JSON.stringify(_this.barChartData2));
            clone2[0].data = data2;
            _this.barChartData2 = clone2;
